            ...
            <div className="mx-auto max-w-7xl px-6 py-10 lg:px-8">
                <div className="grid gap-10 md:grid-cols-5">
                    <div className="text-center md:col-span-2 md:text-left">
                        ...
                        />
                        <p className="mx-auto mt-4 max-w-[384px] text-xs leading-5 text-[#64748B] md:mx-0">Curated tools, technologies, and resources for developers building
                            modern software.</p>
                    ...
                    <div className="hidden md:block">
                        <h3 className="text-xs font-bold text-[#0F172A]">Product</h3>
                    ...
                    <div className="hidden md:block">
                        <h3 className="text-xs font-bold text-[#0F172A]">Company</h3>
                    ...
                    <div className="hidden md:block">
                        <h3 className="text-xs font-bold text-[#0F172A]">Legal</h3>
